...
<head>
    ...
    <title>ELMS - Department Leave Chart</title>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="mb-8">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-white mb-2">Department Leave Chart</h1>
                            <p class="text-slate-400">View and manage leave requests for <?php echo htmlspecialchars($me['department']); ?> department</p>
                        </div>
                    </div>
                </div>
