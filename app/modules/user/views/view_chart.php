...
<head>
    ...
    <title>ELMS - Employee Leave Chart</title>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="mb-8">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-white mb-2">Employee Leave Chart</h1>
                            <p class="text-slate-400">View your leave requests and approved leave from colleagues</p>
                        </div>
                    </div>
                </div>
