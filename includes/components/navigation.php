...
function getNavigation($user_role = 'user') {
    if ($user_role === 'admin') {
        return [
            ...
            ['url' => 'calendar.php', 'title' => 'Calendar', 'icon' => 'fas fa-calendar'],
            ['url' => 'reports.php', 'title' => 'Reports', 'icon' => 'fas fa-chart-line'],
            ['url' => '../../app/modules/user/views/profile.php', 'title' => 'Profile', 'icon' => 'fas fa-user'],
            ['url' => '../../../../auth/controllers/logout.php', 'title' => 'Logout', 'icon' => 'fas fa-sign-out-alt']
        ];
